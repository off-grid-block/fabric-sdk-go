...
import (
	...
	context2 "github.com/off-grid-block/fabric-sdk-go/pkg/context"
	contextImpl "github.com/off-grid-block/fabric-sdk-go/pkg/context"
	configImpl "github.com/off-grid-block/fabric-sdk-go/pkg/core/config"
	...
	mockapisdk "github.com/off-grid-block/fabric-sdk-go/pkg/fabsdk/test/mocksdkapi"
	"github.com/off-grid-block/fabric-sdk-go/pkg/msp"
...
func TestErrorHandler(t *testing.T) {
	...
	errHandler := func(ctxt fab.ClientContext, channelID string, err error) {
		...
		//https://github.com/off-grid-block/fabric-sdk-go/pull/62#issuecomment-605343770
