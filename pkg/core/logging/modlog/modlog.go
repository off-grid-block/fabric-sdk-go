...
import (
	...
	"github.com/off-grid-block/fabric-sdk-go/pkg/core/logging/api"
	"github.com/off-grid-block/fabric-sdk-go/pkg/core/logging/metadata"
)
...
func hasLoggerFnPrefix(pkgPath string, fnName string) bool {
	const (
		loggingAPIPath = "github.com/off-grid-block/fabric-sdk-go/pkg/core/logging/"
		loggingAPIPkg  = "api" // Go < 1.12
		modlogFnPrefix = "modlog.(*Log)."
		loggingPath    = "github.com/off-grid-block/fabric-sdk-go/pkg/common/"
		loggingPkg     = "logging"
		logBridgePath  = "github.com/off-grid-block/fabric-sdk-go/internal/github.com/hyperledger/fabric-ca/sdkpatch/logbridge"
